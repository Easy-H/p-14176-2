...
public class ApiV1PostControllerTest {
    ...
    void t1() throws Exception {
        ResultActions resultActions = mvc
                .perform(
                        post("/api/v1/posts?actorId=%d".formatted(3))
    ...
    void t2() throws Exception {
        ...
        ResultActions resultActions = mvc
                .perform(
                        put("/api/v1/posts/%d?actorId=%d".formatted(id, 3))
                                .contentType(MediaType.APPLICATION_JSON)
                                .content("""
                                        {
                                            "title": "제목",
    ...
    void t3() throws Exception {
        ...
        ResultActions resultActions = mvc
                .perform(delete("/api/v1/posts/%d?actorId=%d".formatted(id, 3)))
                .andDo(print());
        ...
        resultActions
                ...
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.resultCode").value("200-1"))
                .andExpect(jsonPath("$.msg").value("%d번 게시물이 삭제되었습니다.".formatted(id)));
    }
    ...
    void t3_1() throws Exception {
        ...
        ResultActions resultActions = mvc
                .perform(delete("/api/v1/posts/%d?actorId=%d".formatted(id, 1)))
                .andDo(print());
    ...
    void t3_2() throws Exception {
        ...
        ResultActions resultActions = mvc
                .perform(delete("/api/v1/posts/%d".formatted(id)))
                .andDo(print());
